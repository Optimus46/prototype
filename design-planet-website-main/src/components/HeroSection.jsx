...
const HeroSection = () => {
  return (
    <section id="home" className='w-full pt-36 min-h-screen bg-gradient-to-r from-[rgb(15,30,68)] via-[#27448D] to-[#3F4088] bg-amber-400-200 text-white md:flex md:items-center md:justify-center'>
